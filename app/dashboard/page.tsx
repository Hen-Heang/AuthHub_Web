                    ...
                    <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                        <div>
                            <h2 className="text-3xl font-bold text-slate-900">
                                Welcome to your Dashboard, {user.name || user.email.split('@')[0]}!
                            </h2>
                            <p className="text-slate-600 mt-2">
                                Here&#39;s an overview of your account information and OAuth details.
                            </p>
                                    ...
                                    <div className="bg-slate-50 p-4 rounded-lg border border-slate-100">
                                        ...
                                        <div className="space-y-2 text-sm">
                                            ...
                                            <div className="flex justify-between">
                                                ...
                                                <span className="font-medium">15 minutes (auto-renewing)</span>
                                            </div>
                                            <div className="flex justify-between">
                        ...
                        <CardContent>
                            <div className="space-y-4">
                                <div className="border-l-2 border-indigo-500 pl-4 py-1">
                                    <p className="text-sm text-slate-700">You logged in to your account</p>
