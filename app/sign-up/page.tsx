...
export default function SignUpPage() {
    ...
    const benefits = [
        {
            ...
            description: "Bank-grade encryption and protection",
        },
        {
            icon: Users,
    ...
    return (
        <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-50">
                ...
                <div className="grid lg:grid-cols-2 gap-12 items-start">
                    ...
                    >
                        <div className="text-center mb-8">
                            ...
                            <p className="text-slate-600">Join thousands of users who trust SecureAuth</p>
                        </div>
                    ...
                    >
                        <div>
                            ...
                            <h2 className="text-3xl font-bold text-slate-900 mb-4">Everything you need to get started</h2>
                            <p className="text-lg text-slate-600 leading-relaxed">
                                Join thousands of developers and businesses who trust SecureAuth for their authentication needs. Get
                                started in minutes with our comprehensive platform.
                            </p>
                        </div>
                        ...
                        <div className="bg-gradient-to-r from-green-600 to-emerald-600 rounded-2xl p-8 text-white">
                            <div className="flex items-center gap-3 mb-4">
                                ...
                                <div>
                                    ...
                                    <p className="text-green-100">No commitment, cancel anytime</p>
                                </div>
                            </div>
                            <p className="text-green-100 leading-relaxed mb-6">
                                Try all premium features free for 30 days. No credit card required. Experience enterprise-grade security
                                with unlimited access to all features.
                            </p>
                            <div className="grid grid-cols-2 gap-4">
                                <div className="text-center">
                                    <div className="text-2xl font-bold">$0</div>
                                    <div className="text-sm text-green-200">First 30 days</div>
                                </div>
                                <div className="text-center">
                                    <div className="text-2xl font-bold">24/7</div>
                                    <div className="text-sm text-green-200">Support included</div>
                                </div>
                            </div>
                        </div>
            ...
            <DebugConnection name={name} email={email} password={password} />
        </div>
    )
}
